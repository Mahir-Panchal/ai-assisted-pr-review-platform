...
const ContributorPage = () => {
  ...
  const { mutate: handleAdd, isPending: adding } = useMutation({
    ...
    onSuccess: () => { toast.success("Contributor added!"); setAddUsername(""); queryClient.invalidateQueries({ queryKey: ["contributors", repoId] }); },
      ...
      {isOwner && (
        <div style={{ display: "grid", gridTemplateColumns: "1fr 1fr", gap: 16, marginBottom: 24 }}>
          ...
          <div style={{ ...S.card, padding: "20px" }}>
            ...
            <p style={{ fontSize: 11, color: "var(--text-muted)", marginTop: 8 }}>Adds immediately without email</p>
          </div>
