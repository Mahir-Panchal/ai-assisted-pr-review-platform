...
const FEATURES = [
  {
    ...
    desc: "Get instant, intelligent feedback on every PR",
  },
  {
    icon: Shield,
    title: "Rule Enforcement",
    desc: "Define custom rules that auto-check compliance",
  },
  {
    icon: Zap,
    title: "Instant Analysis",
    desc: "Code quality scored in seconds, not hours",
  },
];
  ...
  return (
    ...
    >
      ...
      <div
        ...
        style={{
          background:
            "linear-gradient(145deg, #0a0f1a 0%, #0d1117 50%, #0a1628 100%)",
        }}
      >
        {/* Background orbs */}
        <div
        ...
        <div className="relative z-10 w-full max-w-[560px] px-10 xl:px-16 py-16 flex flex-col gap-10">
          {/* Logo */}
          <div>
      ...
      <div className="flex items-center justify-center px-6 py-10 lg:px-12">
        <div className="w-full max-w-[400px] animate-fade-in">
          ...
          <div className="flex items-center gap-2 mb-8 lg:hidden">
            ...
            <span
              style={{ fontWeight: 700, fontSize: 16, color: "#e6edf3" }}
            >
              AI PR Review
            </span>
          </div>
            ...
            <div>
              ...
              {loginType === "email" ? (
                ...
                <input
                  ...
                  type="tel"
                  className="input-field"
                  placeholder="+919876543210 (+91 needed)"
                  value={form.phone}
                  onChange={(e) =>
